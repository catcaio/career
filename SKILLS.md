...
## Técnico / tecnologia (fatos)
- Formação em ADS (cursando): banco de dados, segurança da informação, testes, metodologias ágeis, gestão de software
- Noções de TypeScript, Next.js, SQL, APIs e versionamento Git/GitHub (v. e-commerce)
...
- Comunicação clara, escuta ativa, relacionamento, negociação
- Proatividade, organização, atenção a detalhes, responsabilidade
- Perfil analítico, executor, orientado a metas e a solução
- Facilidade para aprender ferramentas e treinar colegas
